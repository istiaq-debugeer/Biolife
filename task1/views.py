...
from task1.models import Slider, FolloUs, SecondSlider, Cart, CartItem, Comment, CommentAttachment, BlogPost, \
    DealsOfTheDay, Category, Products, Banner, Carousel, Contact, bannerMovinImage, SpecialOffer
